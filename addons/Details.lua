function LoadDetailsUkrainizer()
    local L = LibStub("AceLocale-3.0"):GetLocale("Details")
    local Details = _G.Details

    local replaceFonts = function()
        local detailsFonts = Details.font_faces
        detailsFonts.default = "Interface\\AddOns\\AddonTranslator\\assets\\Arsenal_Regular.ttf"
        detailsFonts.menus = "Interface\\AddOns\\AddonTranslator\\assets\\Arsenal_Regular.ttf"
        detailsFonts.attribute_text = "Interface\\AddOns\\AddonTranslator\\assets\\Arsenal_Regular.ttf"
    end
    ...
    L["ABILITY_ID"] = "ідентифікатор вміння"
    L["STRING_"] = "_"
    L["STRING_ABSORBED"] = "Поглинено"
    L["STRING_ACTORFRAME_NOTHING"] = "на жаль, немає даних для звіту :("
    L["STRING_ACTORFRAME_REPORTAT"] = "на"
    L["STRING_ACTORFRAME_REPORTOF"] = "з"
    L["STRING_ACTORFRAME_REPORTTARGETS"] = "звіт для цілей з"
    L["STRING_ACTORFRAME_REPORTTO"] = "звіт для"
    L["STRING_ACTORFRAME_SPELLDETAILS"] = "Деталі заклинання"
    L["STRING_ACTORFRAME_SPELLSOF"] = "Заклинання"
    L["STRING_ACTORFRAME_SPELLUSED"] = "Всі використані заклинання"
    L["STRING_AGAINST"] = "проти"
    L["STRING_ALIVE"] = "Живий"
    L["STRING_ALPHA"] = "Альфа"
    L["STRING_ANCHOR_BOTTOM"] = "Знизу"
    L["STRING_ANCHOR_BOTTOMLEFT"] = "Знизу зліва"
    L["STRING_ANCHOR_BOTTOMRIGHT"] = "Знизу справа"
    L["STRING_ANCHOR_LEFT"] = "Зліва"
    L["STRING_ANCHOR_RIGHT"] = "Справа"
    L["STRING_ANCHOR_TOP"] = "Зверху"
    L["STRING_ANCHOR_TOPLEFT"] = "Зверху зліва"
    L["STRING_ANCHOR_TOPRIGHT"] = "Зверху справа"
    L["STRING_ASCENDING"] = "За зростанням"
    L["STRING_ATACH_DESC"] = "Вікно #%d створює групу з вікном #%d."
    L["STRING_ATTRIBUTE_CUSTOM"] = "Користувацьке"
    L["STRING_ATTRIBUTE_DAMAGE"] = "Урон"
    L["STRING_ATTRIBUTE_DAMAGE_BYSPELL"] = "Урон, отриманий від заклинань"
    L["STRING_ATTRIBUTE_DAMAGE_DEBUFFS"] = "Ефекти і зони"
    L["STRING_ATTRIBUTE_DAMAGE_DEBUFFS_REPORT"] = "Урон від дебафів та тривалість"
    L["STRING_ATTRIBUTE_DAMAGE_DONE"] = "Нанесений урон"
    L["STRING_ATTRIBUTE_DAMAGE_DPS"] = "УВС"
    L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Отриманий урон від ворога"
    L["STRING_ATTRIBUTE_DAMAGE_ENEMIES_DONE"] = "Нанесений урон ворогу"
    L["STRING_ATTRIBUTE_DAMAGE_FRAGS"] = "Вбивства"
    L["STRING_ATTRIBUTE_DAMAGE_FRIENDLYFIRE"] = "Урон по союзникам"
    L["STRING_ATTRIBUTE_DAMAGE_TAKEN"] = "Отриманий урон"
    L["STRING_ATTRIBUTE_ENERGY"] = "Ресурси"
    L["STRING_ATTRIBUTE_ENERGY_ALTERNATEPOWER"] = "Альтернативна сила"
    L["STRING_ATTRIBUTE_ENERGY_ENERGY"] = "Отримано: Енергія"
    L["STRING_ATTRIBUTE_ENERGY_MANA"] = "Отримано: Мана"
    L["STRING_ATTRIBUTE_ENERGY_RAGE"] = "Отримано: Жага"
    L["STRING_ATTRIBUTE_ENERGY_RESOURCES"] = "Інші ресурси"
    L["STRING_ATTRIBUTE_ENERGY_RUNEPOWER"] = "Отримано: Сила рун"
    L["STRING_ATTRIBUTE_HEAL"] = "Лікування"
    L["STRING_ATTRIBUTE_HEAL_ABSORBED"] = "Поглинене лікування"
    L["STRING_ATTRIBUTE_HEAL_DONE"] = "Лікування"
    L["STRING_ATTRIBUTE_HEAL_ENEMY"] = "Вороже лікування"
    L["STRING_ATTRIBUTE_HEAL_HPS"] = "ІВС"
    L["STRING_ATTRIBUTE_HEAL_OVERHEAL"] = "Зайве лікування"
    L["STRING_ATTRIBUTE_HEAL_PREVENT"] = "Запобігнуто шкоді"
    L["STRING_ATTRIBUTE_HEAL_TAKEN"] = "Отримане лікування"
    L["STRING_ATTRIBUTE_MISC"] = "Інше"
    L["STRING_ATTRIBUTE_MISC_BUFF_UPTIME"] = "Час дії бафів"
    L["STRING_ATTRIBUTE_MISC_CCBREAK"] = "Зняття контролю"
    L["STRING_ATTRIBUTE_MISC_DEAD"] = "Смерті"
    L["STRING_ATTRIBUTE_MISC_DEBUFF_UPTIME"] = "Час дії дебафів"
    L["STRING_ATTRIBUTE_MISC_DEFENSIVE_COOLDOWNS"] = "Кулдауни"
    L["STRING_ATTRIBUTE_MISC_DISPELL"] = "Розсіювання"
    L["STRING_ATTRIBUTE_MISC_INTERRUPT"] = "Переривання"
    L["STRING_ATTRIBUTE_MISC_RESS"] = "Воскресіння"
    L["STRING_AUTO"] = "авто"
    L["STRING_AUTOSHOT"] = "Автоматичний постріл"
    L["STRING_AVERAGE"] = "У середньому"
    L["STRING_BLOCKED"] = "Заблоковано"
    L["STRING_BOTTOM"] = "Знизу"
    L["STRING_BOTTOM_TO_TOP"] = "Знизу вгору"
    L["STRING_CAST"] = "Произнесено"
    L["STRING_CAUGHT"] = "спіймав"
    L["STRING_CCBROKE"] = "Зняття контролю"
    L["STRING_CENTER"] = "центр"
    L["STRING_CENTER_UPPER"] = "Центр"
    L["STRING_CHANGED_TO_CURRENT"] = "Сегмент змінений: |cFFFFFF00Поточний|r"
    L["STRING_CHANNEL_PRINT"] = "Спостерігач"
    L["STRING_CHANNEL_RAID"] = "Рейд"
    L["STRING_CHANNEL_SAY"] = "Сказати"
    L["STRING_CHANNEL_WHISPER"] = "Шепіт"
    L["STRING_CHANNEL_WHISPER_TARGET_COOLDOWN"] = "Шепот до цілі (кд)"
    L["STRING_CHANNEL_YELL"] = "Крикнути"
    L["STRING_CLICK_REPORT_LINE1"] = "|cFFFFCC22Клік|r: |cFFFFEE00звіт|r"
    L["STRING_CLICK_REPORT_LINE2"] = "|cFFFFCC22Shift+ЛКМ|r: |cFFFFEE00режим вікна|r"
    L["STRING_CLOSEALL"] = "Усі вікна закриті. Введіть '/details show', щоб відкрити знову."
    L["STRING_COLOR"] = "Колір"
    L["STRING_COMMAND_LIST"] = "список команд"
    L["STRING_CONTEXT"] = "Контекст"
    L["STRING_COOLTIP_NOOPTIONS"] = "немає параметрів"
    L["STRING_CREATEAURA"] = "Створити ауру"
    L["STRING_CRITICAL_HITS"] = "Критичні удари"
    L["STRING_CRITICAL_ONLY"] = "тільки критичний"
    L["STRING_CURRENT"] = "Поточний"
    L["STRING_CURRENTFIGHT"] = "Поточний сегмент"
    L["STRING_CUSTOM_ACTIVITY_ALL"] = "Активний режим"
    L["STRING_CUSTOM_ACTIVITY_ALL_DESC"] = "Показує результати активності для кожного гравця в рейдовій групі."
    L["STRING_CUSTOM_ACTIVITY_DPS"] = "Урон (активність)"
    L["STRING_CUSTOM_ACTIVITY_DPS_DESC"] = "Показує, скільки часу кожен персонаж провів на нанесення урону."
    L["STRING_CUSTOM_ACTIVITY_HPS"] = "Лікування (активність)"
    L["STRING_CUSTOM_ACTIVITY_HPS_DESC"] = "Показує, скільки часу кожен персонаж провів на лікування."
    L["STRING_CUSTOM_ATTRIBUTE_DAMAGE"] = "Урон"
    L["STRING_CUSTOM_ATTRIBUTE_HEAL"] = "Лікування"
    L["STRING_CUSTOM_ATTRIBUTE_SCRIPT"] = "Власний скрипт"
    L["STRING_CUSTOM_AUTHOR"] = "Автор:"
    L["STRING_CUSTOM_AUTHOR_DESC"] = "Хто створив цей дисплей."
    L["STRING_CUSTOM_CANCEL"] = "Скасувати"
    L["STRING_CUSTOM_CC_DONE"] = "Контроль толпи виконано"
    L["STRING_CUSTOM_CC_RECEIVED"] = "Контроль толпи отримано"
    L["STRING_CUSTOM_CREATE"] = "Створити"
    L["STRING_CUSTOM_CREATED"] = "Новий дисплей був створений."
    L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET"] = "Нанесений урон по іншим позначеним цілям"
    L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET_DESC"] =
    "Показує кількість нанесеного урону цілям, позначеним будь-яким іншим позначенням."
    L["STRING_CUSTOM_DAMAGEONSHIELDS"] = "Нанесений урон по щитам"
    L["STRING_CUSTOM_DAMAGEONSKULL"] = "Нанесений урон по позначенню черепом"
    L["STRING_CUSTOM_DAMAGEONSKULL_DESC"] = "Показує кількість нанесеного урону цілям, позначеним черепом."
    L["STRING_CUSTOM_DESCRIPTION"] = "Опис:"
    L["STRING_CUSTOM_DESCRIPTION_DESC"] = "Опис того, що робить цей дисплей."
    L["STRING_CUSTOM_DONE"] = "Готово"
    L["STRING_CUSTOM_DTBS"] = "Урон, отриманий від заклинань"
    L["STRING_CUSTOM_DTBS_DESC"] = "Показати урон від ворожих заклинань, отриманий вашою групою."
    L["STRING_CUSTOM_DYNAMICOVERAL"] = "Динамічний загальний урон"
    L["STRING_CUSTOM_EDIT"] = "Редагувати"
    L["STRING_CUSTOM_EDIT_SEARCH_CODE"] = "Змінити код пошуку"
    L["STRING_CUSTOM_EDIT_TOOLTIP_CODE"] = "Змінити код підказки"
    L["STRING_CUSTOM_EDITCODE_DESC"] = "Це додаткова функція, де користувач може створити свій власний код дисплея."
    L["STRING_CUSTOM_EDITTOOLTIP_DESC"] =
    "Це код підказки, який виконується, коли користувач наводить вказівник миші на смугу."
    L["STRING_CUSTOM_ENEMY_DT"] = "Отриманий урон"
    L["STRING_CUSTOM_EXPORT"] = "Експорт"
    L["STRING_CUSTOM_FUNC_INVALID"] = "Власний скрипт неприпустимий і не може оновити вікно."
    L["STRING_CUSTOM_HEALTHSTONE_DEFAULT"] = "Лікувальне зілля та камінь"
    L["STRING_CUSTOM_HEALTHSTONE_DEFAULT_DESC"] =
    "Показує, хто в вашій рейдовій групі використовував камінь здоров'я або лікувальне зілля."
    L["STRING_CUSTOM_ICON"] = "Іконка:"
    L["STRING_CUSTOM_IMPORT"] = "Імпорт"
    L["STRING_CUSTOM_IMPORT_ALERT"] = "Дисплей завантажено, натисніть, щоб підтвердити імпорт."
    L["STRING_CUSTOM_IMPORT_BUTTON"] = "Імпорт"
    L["STRING_CUSTOM_IMPORT_ERROR"] = "Помилка імпорту, неприпустимий рядок."
    L["STRING_CUSTOM_IMPORTED"] = "Дисплей успішно імпортовано."
    L["STRING_CUSTOM_LONGNAME"] = "Назва занадто довга, максимально допустимо 32 символи."
    L["STRING_CUSTOM_MYSPELLS"] = "Мої заклинання"
    L["STRING_CUSTOM_MYSPELLS_DESC"] = "Показує ваші заклинання в вікні."
    L["STRING_CUSTOM_NAME"] = "Назва:"
    L["STRING_CUSTOM_NAME_DESC"] = "Введіть назву нового користувацького дисплея."
    L["STRING_CUSTOM_NEW"] = "Керування користувацькими дисплеями"
    L["STRING_CUSTOM_PASTE"] = "Вставити сюди:"
    L["STRING_CUSTOM_POT_DEFAULT"] = "Використано зель"
    L["STRING_CUSTOM_POT_DEFAULT_DESC"] = "Показує, хто в вашому рейді використовував зелье під час битви."
    L["STRING_CUSTOM_REMOVE"] = "Видалити"
    L["STRING_CUSTOM_REPORT"] = "(ваше)"
    L["STRING_CUSTOM_SAVE"] = "Зберегти зміни"
    L["STRING_CUSTOM_SAVED"] = "Дисплей збережений."
    L["STRING_CUSTOM_SHORTNAME"] = "Назва повинна містити не менше 5 символів."
    L["STRING_CUSTOM_SKIN_TEXTURE"] = "Файл вашого скина"
    L["STRING_CUSTOM_SKIN_TEXTURE_DESC"] = [=[Розширення файлу .tga

Файл повинен бути розміщений у папці:

|cFFFFFF00WoW/Interface/|r

|cFFFFFF00Важливо:|r перед створенням файлу закрийте свій гейм-клієнт. Після цього напишіть /reload, щоб застосувати зміни, збережені в файлі текстури.]=]
    L["STRING_CUSTOM_SOURCE"] = "Джерело:"
    L["STRING_CUSTOM_SOURCE_DESC"] = [=[Хто викликав ефект.

Права кнопка показує список NPC з рейдових боїв.]=]
    L["STRING_CUSTOM_SPELLID"] = "ID заклинання:"
    L["STRING_CUSTOM_SPELLID_DESC"] =
    [=[Необов'язково, що використовуване заклинання є джерелом для застосування ефекту до цілі.

Права кнопка показує список заклинань з рейдових боїв.]=]
    L["STRING_CUSTOM_TARGET"] = "Ціль:"
    L["STRING_CUSTOM_TARGET_DESC"] = [=[Ця ціль є джерелом.

Права кнопка показує список NPC з рейдових боїв.]=]
    L["STRING_CUSTOM_TEMPORARILY"] = "(|cFFFFC000тимчасово|r)"
    L["STRING_CUSTOM_TEXTURE_GUIDE"] =
    "Щоб завантажити текстурний файл до клієнта World of Warcraft, вам потрібний файл у форматі .TGA, а також його ширина та висота повинні бути кратні 8. Розмістіть текстуру у папці /місце_встановленого_клієнта_WoW/retail/Interface/"
    L["STRING_DAMAGE"] = "Урон"
    L["STRING_DAMAGE_DPS_IN"] = "Урон, отриманий від "
    L["STRING_DAMAGE_FROM"] = "Отримав урон від"
    L["STRING_DAMAGE_TAKEN_FROM"] = "Отриманий урон від"
    L["STRING_DAMAGE_TAKEN_FROM2"] = "отриманий урон від"
    L["STRING_DEFENSES"] = "Захист"
    L["STRING_DESCENDING"] = "У зворотному порядку"
    L["STRING_DETACH_DESC"] = "Розділити групу вікон"
    L["STRING_DISCARD"] = "Відхилити"
    L["STRING_DISPELLED"] = "Бафи/Дебафи зняті"
    L["STRING_DODGE"] = "Ухилення"
    L["STRING_DOT"] = "(DoT)"
    L["STRING_DPS"] = "УВС"
    L["STRING_EMPTY_SEGMENT"] = "Порожній сегмент"
    L["STRING_ENABLED"] = "Увімкнути"
    L["STRING_ENVIRONMENTAL_DROWNING"] = "Світ (топлення)"
    L["STRING_ENVIRONMENTAL_FALLING"] = "Світ (падіння)"
    L["STRING_ENVIRONMENTAL_FATIGUE"] = "Світ (втома)"
    L["STRING_ENVIRONMENTAL_FIRE"] = "Світ (вогонь)"
    L["STRING_ENVIRONMENTAL_LAVA"] = "Світ (лава)"
    L["STRING_ENVIRONMENTAL_SLIME"] = "Світ (слизь)"

    L["STRING_EQUILIZING"] = "Обмін даними під час битви"
    L["STRING_ERASE"] = "видалити"
    L["STRING_ERASE_DATA"] = "Скидання всіх даних"
    L["STRING_ERASE_DATA_OVERALL"] = "Повне скидання даних"
    L["STRING_ERASE_IN_COMBAT"] = "Заплановане повне очищення після поточного бою."
    L["STRING_EXAMPLE"] = "Приклад"
    L["STRING_EXPLOSION"] = "вибух"
    L["STRING_FAIL_ATTACKS"] = "Невдалий удари"
    L["STRING_FEEDBACK_CURSE_DESC"] = "Відкрийте заявку або залиште повідомлення на сторінці Details!."
    L["STRING_FEEDBACK_MMOC_DESC"] = "Напишіть у нашій темі на форумі mmo-champion."
    L["STRING_FEEDBACK_PREFERED_SITE"] = "Оберіть бажаний сайт спільноти (англ):"
    L["STRING_FEEDBACK_SEND_FEEDBACK"] = "Надіслати відгук"
    L["STRING_FEEDBACK_WOWI_DESC"] = "Залишити коментар на сторінці проекту Details!"
    L["STRING_FIGHTNUMBER"] = "Бій №"
    L["STRING_FORGE_BUTTON_ALLSPELLS"] = "Всі закляття"
    L["STRING_FORGE_BUTTON_ALLSPELLS_DESC"] = "Список усіх заклять від гравців і НПС."
    L["STRING_FORGE_BUTTON_BWTIMERS"] = "Таймери BigWigs"
    L["STRING_FORGE_BUTTON_BWTIMERS_DESC"] = "Список таймерів з BigWigs"
    L["STRING_FORGE_BUTTON_DBMTIMERS"] = "Таймери DBM"
    L["STRING_FORGE_BUTTON_DBMTIMERS_DESC"] = "Список таймерів з Deadly Boss Mods"
    L["STRING_FORGE_BUTTON_ENCOUNTERSPELLS"] = "Закляття боса"
    L["STRING_FORGE_BUTTON_ENCOUNTERSPELLS_DESC"] = "Список заклять з рейдів та підземелль з битвами."
    L["STRING_FORGE_BUTTON_ENEMIES"] = "Вороги"
    L["STRING_FORGE_BUTTON_ENEMIES_DESC"] = "Список ворогів з поточного бою."
    L["STRING_FORGE_BUTTON_PETS"] = "Підопічні"
    L["STRING_FORGE_BUTTON_PETS_DESC"] = "Список підопічних з поточного бою."
    L["STRING_FORGE_BUTTON_PLAYERS"] = "Гравці"
    L["STRING_FORGE_BUTTON_PLAYERS_DESC"] = "Список гравців з поточного бою."
    L["STRING_FORGE_ENABLEPLUGINS"] =
    "Будь ласка, увімкніть плагіни Details! з назвами рейдів У головному меню> Модифікації, наприклад Details: Tomb of Sargeras."
    L["STRING_FORGE_FILTER_BARTEXT"] = "Назва смуги"
    L["STRING_FORGE_FILTER_CASTERNAME"] = "Ім'я заклинача"
    L["STRING_FORGE_FILTER_ENCOUNTERNAME"] = "Ім'я сутички"
    L["STRING_FORGE_FILTER_ENEMYNAME"] = "Ім'я ворога"
    L["STRING_FORGE_FILTER_OWNERNAME"] = "Ім'я власника"
    L["STRING_FORGE_FILTER_PETNAME"] = "Ім'я підопічного"
    L["STRING_FORGE_FILTER_PLAYERNAME"] = "Ім'я гравця"
    L["STRING_FORGE_FILTER_SPELLNAME"] = "Назва закляття"
    L["STRING_FORGE_HEADER_BARTEXT"] = "Текст смуги"
    L["STRING_FORGE_HEADER_CASTER"] = "Заклинач"
    L["STRING_FORGE_HEADER_CLASS"] = "Клас"
    L["STRING_FORGE_HEADER_CREATEAURA"] = "Створити ауру"
    L["STRING_FORGE_HEADER_ENCOUNTERID"] = "ID сутички"
    L["STRING_FORGE_HEADER_ENCOUNTERNAME"] = "Ім'я сутички"
    L["STRING_FORGE_HEADER_EVENT"] = "Подія"
    L["STRING_FORGE_HEADER_FLAG"] = "Прапорець"
    L["STRING_FORGE_HEADER_GUID"] = "GUID"
    L["STRING_FORGE_HEADER_ICON"] = "Іконка"
    L["STRING_FORGE_HEADER_ID"] = "ID"
    L["STRING_FORGE_HEADER_INDEX"] = "Індекс"
    L["STRING_FORGE_HEADER_NAME"] = "Ім'я"
    L["STRING_FORGE_HEADER_NPCID"] = "ID НПС"
    L["STRING_FORGE_HEADER_OWNER"] = "Власник"
    L["STRING_FORGE_HEADER_SCHOOL"] = "Школа"
    L["STRING_FORGE_HEADER_SPELLID"] = "ID закляття"
    L["STRING_FORGE_HEADER_TIMER"] = "Таймер"
    L["STRING_FORGE_TUTORIAL_DESC"] = [=[Переглядайте закляття та таймери босс-модів для створення аур, натисніть на

'|cFFFFFF00Створити ауру|r'.]=]
    L["STRING_FORGE_TUTORIAL_TITLE"] = "Ласкаво просимо до Кузні Details!"
    L["STRING_FORGE_TUTORIAL_VIDEO"] = "Приклад аури з використанням таймерів босс-мода:"
    L["STRING_FREEZE"] = "Цей сегмент наразі недоступний"
    L["STRING_FROM"] = "Від"
    L["STRING_GERAL"] = "Загальне"
    L["STRING_GLANCING"] = "Мимоволі"
    L["STRING_GUILDDAMAGERANK_BOSS"] = "Босс"
    L["STRING_GUILDDAMAGERANK_DATABASEERROR"] = [=[Неможливо відкрити '|cFFFFFF00Details! зберігання|r', можливо аддон
вимкнено?]=]
    L["STRING_GUILDDAMAGERANK_DIFF"] = "Складність"
    L["STRING_GUILDDAMAGERANK_GUILD"] = "Гільдія"
    L["STRING_GUILDDAMAGERANK_PLAYERBASE"] = "База гравців"
    L["STRING_GUILDDAMAGERANK_PLAYERBASE_INDIVIDUAL"] = "Окремий"
    L["STRING_GUILDDAMAGERANK_PLAYERBASE_PLAYER"] = "Гравець"
    L["STRING_GUILDDAMAGERANK_PLAYERBASE_RAID"] = "Всі гравці"
    L["STRING_GUILDDAMAGERANK_RAID"] = "Рейд"
    L["STRING_GUILDDAMAGERANK_ROLE"] = "Роль"
    L["STRING_GUILDDAMAGERANK_SHOWHISTORY"] = "історію"
    L["STRING_GUILDDAMAGERANK_SHOWRANK"] = "ранг гільдії"
    L["STRING_GUILDDAMAGERANK_SYNCBUTTONTEXT"] = "Синхронізація з гільдією"
    L["STRING_GUILDDAMAGERANK_TUTORIAL_DESC"] =
    [=[Details! зберігає урон та лікування з кожного боса, з яким боролась ваша гільдія.

Щоб переглянути історію, встановіть прапорець на '|cFFFFFF00Показати історію|r', будуть показані результати всіх боїв.
Обравши '|cFFFFFF00Показати ранг гільдії|r', будуть показані найвищі очки для обраного боса.

Якщо ви використовуєте цей інструмент вперше або пропустили день рейду, натисніть кнопку '|cFFFFFF00Синхронізація з гільдією|r'.]=]
    L["STRING_GUILDDAMAGERANK_WINDOWALERT"] = "Босс переможений! показати рейтинг"
    L["STRING_HEAL"] = "Лікування"
    L["STRING_HEAL_ABSORBED"] = "Лікування поглинуто"
    L["STRING_HEAL_CRIT"] = "Критичне лікування"
    L["STRING_HEALING_FROM"] = "Лікування, отримане від"
    L["STRING_HEALING_HPS_FROM"] = "ЛЧВ, отримане від"
    L["STRING_HITS"] = "Удари"
    L["STRING_HPS"] = "ЛЧВ"
    L["STRING_IMAGEEDIT_ALPHA"] = "Прозорість"
    L["STRING_IMAGEEDIT_CROPBOTTOM"] = "Обрізати знизу"
    L["STRING_IMAGEEDIT_CROPLEFT"] = "Обрізати зліва"
    L["STRING_IMAGEEDIT_CROPRIGHT"] = "Обрізати справа"
    L["STRING_IMAGEEDIT_CROPTOP"] = "Обрізати зверху"
    L["STRING_IMAGEEDIT_DONE"] = "ГОТОВО"
    L["STRING_IMAGEEDIT_FLIPH"] = "Відобразити по горизонталі"
    L["STRING_IMAGEEDIT_FLIPV"] = "Відобразити по вертикалі"
    L["STRING_INFO_TAB_AVOIDANCE"] = "Уникнення"
    L["STRING_INFO_TAB_COMPARISON"] = "Порівняння"
    L["STRING_INFO_TAB_SUMMARY"] = "Загалом"
    L["STRING_INFO_TUTORIAL_COMPARISON1"] =
    "Натисніть на вкладку |cFFFFDD00Порівняння|r, щоб побачити порівняння між гравцями одного класу."
    L["STRING_INSTANCE_CHAT"] = "Рейд, група, шукаю групу"
    L["STRING_INSTANCE_LIMIT"] =
    "досягнуто максимальну кількість вікон, це обмеження можна змінити на панелі параметри. Також можна відкрити закриті вікна з меню вікна (#)."
    L["STRING_INTERFACE_OPENOPTIONS"] = "Відкрити панель параметрів"
    L["STRING_INVERT_RULE"] = "Інвертувати правило"
    L["STRING_ISA_PET"] = "Цей суб'єкт є петом"
    L["STRING_KEYBIND_BOOKMARK"] = "Закладка"
    L["STRING_KEYBIND_BOOKMARK_NUMBER"] = "Закладка №%s"
    L["STRING_KEYBIND_RESET_SEGMENTS"] = "Скинути сегменти"
    L["STRING_KEYBIND_SCROLL_DOWN"] = "Прокрутити вниз усі вікна"
    L["STRING_KEYBIND_SCROLL_UP"] = "Прокрутити вгору усі вікна"
    L["STRING_KEYBIND_SCROLLING"] = "Прокрутка"
    L["STRING_KEYBIND_SEGMENTCONTROL"] = "Сегменти"
    L["STRING_KEYBIND_TOGGLE_WINDOW"] = "Перемкнути вікно №%s"
    L["STRING_KEYBIND_TOGGLE_WINDOWS"] = "Перемкнути все"
    L["STRING_KEYBIND_WINDOW_CONTROL"] = "Вікна"
    L["STRING_KEYBIND_WINDOW_REPORT"] = "Звіт даних, що відображаються в вікні №%s."
    L["STRING_KEYBIND_WINDOW_REPORT_HEADER"] = "Звіт даних"
    L["STRING_KILLED"] = "Вбитий"
    L["STRING_LAST_COOLDOWN"] = "останні використані кулдауни"
    L["STRING_LEFT"] = "зліва"
    L["STRING_LEFT_CLICK_SHARE"] = "ЛКМ для звіту."
    L["STRING_LEFT_TO_RIGHT"] = "Зліва направо"
    L["STRING_LOCK_DESC"] = "Заблокувати або розблокувати вікно"
    L["STRING_LOCK_WINDOW"] = "заблокувати"
    L["STRING_MASTERY"] = "Майстерність"
    L["STRING_MAXIMUM"] = "Максимальне"
    L["STRING_MAXIMUM_SHORT"] = "Макс."
    L["STRING_MEDIA"] = "Медіа"
    L["STRING_MELEE"] = "Ближній бій"
    L["STRING_MEMORY_ALERT_BUTTON"] = "Я зрозумів"
    L["STRING_MEMORY_ALERT_TEXT1"] =
    "Details! використовує багато пам'яті, але, |cFFFF8800незважаючи на поширену думку|r, використання пам'яті аддонами |cFFFF8800не впливає|r на продуктивність гри або на ваш FPS."
    L["STRING_MEMORY_ALERT_TEXT2"] = [=[Тому, якщо ви бачите, що Details! використовує багато пам'яті, не панікуйте :D
|cFFFF8800Все гаразд!|r Частина цієї пам'яті |cFFFF8800використовується в кешуванні|r, щоб зробити аддон швидшим.]=]
    L["STRING_MEMORY_ALERT_TEXT3"] =
    "Однак, якщо ви хочете дізнатися, |cFFFF8800які аддони 'важчі'|r або які зменшують FPS, встановіть аддон: '|cFFFFFF00AddOns Cpu Usage|r'."
    L["STRING_MEMORY_ALERT_TITLE"] = "Будь ласка, уважно прочитайте!"
    L["STRING_MENU_CLOSE_INSTANCE"] = "Закрити це вікно"
    L["STRING_MENU_CLOSE_INSTANCE_DESC"] =
    "Закрите вікно є неактивним і може бути відновлене у будь-який час через меню управління вікнами."
    L["STRING_MENU_CLOSE_INSTANCE_DESC2"] = "Щоб повністю знищити вікно, перевірте розділ 'Різне' на панелі параметрів"
    L["STRING_MENU_INSTANCE_CONTROL"] = "Управління вікном"
    L["STRING_MINIMAP_TOOLTIP1"] = "|cFFCFCFCFЛіва кнопка|r: відкрити панель параметрів"
    L["STRING_MINIMAP_TOOLTIP11"] = "|cFFCFCFCFЛіва кнопка|r: очистити всі сегменти"
    L["STRING_MINIMAP_TOOLTIP12"] = "|cFFCFCFCFЛіва кнопка|r: показати/приховати вікна"
    L["STRING_MINIMAP_TOOLTIP2"] = "|cFFCFCFCFПрава кнопка|r: швидке меню"
    L["STRING_MINIMAPMENU_CLOSEALL"] = "Закрити все"
    L["STRING_MINIMAPMENU_HIDEICON"] = "Приховати піктограму на міні-карті"
    L["STRING_MINIMAPMENU_LOCK"] = "Заблокувати"
    L["STRING_MINIMAPMENU_NEWWINDOW"] = "Створити нове вікно"
    L["STRING_MINIMAPMENU_REOPENALL"] = "Відкрити все"
    L["STRING_MINIMAPMENU_UNLOCK"] = "Розблокувати"
    L["STRING_MINIMUM"] = "Мінімальне"
    L["STRING_MINIMUM_SHORT"] = "Мін."
    L["STRING_MINITUTORIAL_BOOKMARK1"] = "Права кнопка в будь-якій частині вікна, щоб відкрити закладки!"
    L["STRING_MINITUTORIAL_BOOKMARK2"] = "Закладки дають швидкий доступ до обраних дисплеїв."
    L["STRING_MINITUTORIAL_BOOKMARK3"] = "Права кнопка, щоб закрити панель закладок."
    L["STRING_MINITUTORIAL_BOOKMARK4"] = "Не показувати це знову."
    L["STRING_MINITUTORIAL_CLOSECTRL1"] = "|cFFFFFF00Ctrl + Права кнопка|r закриває вікно!"
    L["STRING_MINITUTORIAL_CLOSECTRL2"] =
    "Якщо ви хочете відкрити це знову, перейдіть в Меню -> Управління вікнами або панель параметрів."
    L["STRING_MINITUTORIAL_OPTIONS_PANEL1"] = "Вікно, яке буде редагуватися."
    L["STRING_MINITUTORIAL_OPTIONS_PANEL2"] = "При перевірці всіх вікон у групі, вони також змінюються."
    L["STRING_MINITUTORIAL_OPTIONS_PANEL3"] = [=[Щоб створити групу, перетягніть вікно #2 поряд з вікном #1.

Щоб розірвати групу, натисніть на кнопку |cFFFFFF00розірвати групу|r.]=]
    L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Перевірте конфігурацію, створивши смужки тестування."
    L["STRING_MINITUTORIAL_OPTIONS_PANEL5"] = "Коли включено 'Редагування групи', всі вікна у групі змінюються."
    L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Виберіть тут, яке вікно ви хочете змінити для зовнішнього вигляду."
    L["STRING_MINITUTORIAL_WINDOWS1"] = [=[Ви щойно створили групу вікон.

Щоб розірвати їх, клікніть на замок.]=]
    L["STRING_MINITUTORIAL_WINDOWS2"] = [=[Вікно заблоковано.

Натисніть на рядок смуги і перетягніть його вгору, щоб розтягнути.]=]
    L["STRING_MIRROR_IMAGE"] = "Дзеркальне зображення"
    L["STRING_MISS"] = "Промах"
    L["STRING_MODE_ALL"] = "Все і кожен"
    L["STRING_MODE_GROUP"] = "Стандартний"
    L["STRING_MODE_OPENFORGE"] = "Список заклинань"
    L["STRING_MODE_PLUGINS"] = "плагіни"
    L["STRING_MODE_RAID"] = "Плагіни: Рейд"
    L["STRING_MODE_SELF"] = "Плагіни: Одиночна гра"
    L["STRING_MORE_INFO"] = "Див. справа для додаткової інформації."
    L["STRING_MULTISTRIKE"] = "Багаторазовий удар"
    L["STRING_MULTISTRIKE_HITS"] = "Багаторазові попадання"
    L["STRING_MUSIC_DETAILS_ROBERTOCARLOS"] = [=[Неможливо спробувати забути
Довго в твоєму житті я буду жити
Details, як малі з нас.]=]
    L["STRING_NEWROW"] = "очікування оновлення..."
    L["STRING_NEWS_REINSTALL"] = "Виявлені проблеми після оновлення? Спробуйте команду '/details reinstall'."
    L["STRING_NEWS_TITLE"] = "Що нового в цій версії"
    L["STRING_NO"] = "Ні"
    L["STRING_NO_DATA"] = "дані вже очищені"
    L["STRING_NO_SPELL"] = "здібності не були використані"
    L["STRING_NO_TARGET"] = "Не знайдено ціль."
    L["STRING_NO_TARGET_BOX"] = "Немає доступних цілей"
...
Измените лимит на панели параметров.]=]
    ...
    "используется в странах Восточной Азии, разделяет тысячи и мириады."
...
|cFFFFFF00Важно|r: некоторые модели игнорируют степень прозрачности.]=]
    ...
    "Выравнивание выполняется автоматически в зависимости от длины каждого текста."
    L["STRING_OPTIONS_ALIGNED_TEXT_COLUMNS_DESC"] =
    "Отключить скобки и разделители и выровнять тексты полос в вертикальных столбцах"
    ...
    "Один и тот же профиль используется для всех персонажей. Вы можете переопределить это для любого персонажа, просто выбрав другой существующий профиль."
    L["STRING_OPTIONS_ALWAYSSHOWPLAYERS"] = "Показать разгруппированных игроков"
    L["STRING_OPTIONS_ALWAYSSHOWPLAYERS_DESC"] =
    "При использовании стандартного режима по умолчанию, показывать персонажей игроков, даже если они не в группе с вами."
    ...
    "При включении полосы прокрутки, при отображении или скрытии используется анимация."
    ...
    "Когда в специализации боец, это окно показывает выбранный атрибут или плагин."
...
|cFFFFFF00Важно|r: Отдельный атрибут, выбранный для каждой роли, перезаписывает выбранный здесь атрибут.]=]
    ...
    "Когда в специализации лекаря, это окно показывает выбранный атрибут или плагин."
    L["STRING_OPTIONS_AUTO_SWITCH_TANK_DESC"] =
    "Когда в специализации танка, это окно показывает выбранный атрибут или плагин."
    L["STRING_OPTIONS_AUTO_SWITCH_WIPE"] = "После вайпа"
    L["STRING_OPTIONS_AUTO_SWITCH_WIPE_DESC"] =
    "После неудачной попытки или поражения в рейдовом сражении, это окно автоматически показывает этот атрибут."
    L["STRING_OPTIONS_AVATAR"] = "Выберите аватар"
    L["STRING_OPTIONS_AVATAR_ANCHOR"] = "Идентификатор:"
    L["STRING_OPTIONS_AVATAR_DESC"] =
    "Аватары также отправляются участникам гильдии и отображаются в верхней части подсказок, и в окне details игрока."
    ...
    "Эта текстура находится ниже верхней текстуры и ее размер всегда такой же, как ширина окна."
...
|cFFFFFF00Важно|r: Выбранный цвет игнорируется при использовании цветов класса.]=]
    ...
    "Когда включено, полоса будет всегда отображаться, даже если Вы не один из лучших игроков в рейтинге."
...
Изображение должно быть в .tga файле, 256x256 пикселей с альфа-каналом.]=]
    ...
    "Когда включено, левый текст формируется в соответствии с правилами в поле."
...
|cFFFFFF00Escape Sequences|r: используется для изменения цвета или добавления текстур. Для получения более подробной информации напишите в поисковике 'UI escape sequences'.]=]
    ...
    "Когда включено, текст справа формируется в соответствии с правилами в поле."
    L["STRING_OPTIONS_BARRIGHTTEXTCUSTOM2"] = "."
    L["STRING_OPTIONS_BARRIGHTTEXTCUSTOM2_DESC"] =
    [=[|cFFFFFF00{data1}|r: это первое пройденное число, обычно это число представляет итоговое выполненное.
...
Это полезно при использовании пакета значков с прозрачными областями.]=]
    ...
    [=[Когда включено, вражеские игроки также отображаются, когда окно находится в режиме группы.
...
- |cFFFFFF00Предотвращение урона|r]=]
    ...
    "Когда включено, сегменты очистки мусора удаляются автоматически, после двух других сегментов."
    L["STRING_OPTIONS_CLICK_TO_OPEN_MENUS"] = "Нажмите, чтобы открыть меню"
    L["STRING_OPTIONS_CLICK_TO_OPEN_MENUS_DESC"] =
    [=[Кнопки полос заголовка не будут показывать меню при наведении курсора на них.

Вместо этого необходимо щелкнуть на них, чтобы открыть.]=]
    L["STRING_OPTIONS_CLOUD"] = "Облако захвата"
    L["STRING_OPTIONS_CLOUD_DESC"] =
    "Когда включено, данные отключенных сборщиков собираются среди других участников рейда."
...
|cFFFFFF00{time}|r: прошедшее время боя.]=]
    ...
    "Эта панель позволяет создавать настраиваемые данные для создания диаграмм."
...
|cFFFFFF00Совет|r: правый щелчок, чтобы вручную ввести значение.]=]
    ...
    "При включении этого параметра, все значки меню на панели инструментов становятся черно-белыми."
    L["STRING_OPTIONS_DISABLE_ALLDISPLAYSWINDOW"] = "Отключить меню 'Все дисплеи'"
    L["STRING_OPTIONS_DISABLE_ALLDISPLAYSWINDOW_DESC"] =
    "Если включено, при щелчке правой кнопкой на полосе заголовка появится закладка."
    ...
    "Кнопки изменения размера, заблокировать/разблокировать и разгруппировки не отображаются, когда вы наводите курсор на окно."
    L["STRING_OPTIONS_DISABLE_RESET"] = "Отключить кнопку сброса"
    L["STRING_OPTIONS_DISABLE_RESET_DESC"] =
    "Когда включено, нажатие на кнопку сброса не будет работать, необходимо выбрать, чтобы сбросить данные из меню подсказки."
...
|cFFFFFF00Авто|r: очистка данных после входа в новое подземелье.]=]
    ...
    "Во время выхода, все данные боя, собранные для создания графиков, стираются."
...
|cFFFFFF00Важно|r: после включения значка рекомендуется настроить размещение текста заголовка.]=]
    ...
    [=[Изменяет прозрачность на это значение, когда Ваш персонаж соответствует выбранному правилу.
...
|cFFFFFF001 - 100|r: не скрыто, изменяется только прозрачность, Вы можете взаимодействовать с окном.]=]
    ...
    "Выберите, что делать, когда кнопка на полосе Hotcorner нажата левой кнопкой мыши."
...
Быстрая кнопка локализуется на самом дальнем левом верхнем пикселе, перемещая мышь до упора, активирует верхний левый hot corner и, если щелкнуть, выполняется действие.]=]
    ...
    "Выберите, что делать при нажатии кнопки быстрого щелчка на Hotcorner."
    L["STRING_OPTIONS_IGNORENICKNAME"] = "Игнорировать псевдонимы и аватары"
    L["STRING_OPTIONS_IGNORENICKNAME_DESC"] =
    "Когда включено, псевдонимы и аватары, установленные другими участниками гильдии, игнорируются."
    L["STRING_OPTIONS_ILVL_TRACKER"] = "Отслеживание уровня предметов:"
    L["STRING_OPTIONS_ILVL_TRACKER_DESC"] =
    [=[Когда включено, и выходите из боя, аддон запрашивает и отслеживает уровень предметов игроков в рейде.
...
|cFFFFFF00По умолчанию|r: Details Background.]=]
    ...
    "Всякий раз, когда начинается бой, это окно автоматически переключается на текущий сегмент."
...
При изменении высоты слоя могут возникнуть конфликты с перекрывающимися друг с другом панелями.]=]
    ...
    "Когда включено, изменение сегмента делает все остальные окна также переключенными на выбранный раздел."
...
Вы можете управлять окнами через меню управления окнами.]=]
    ...
    [=[При включении прозрачность изменяется автоматически при наведении курсора мыши и выходе из окна.
...
|cFFFFFF00Важно|r: Эти настройки перезаписывают альфу, выбранную в окне цвета параметра в разделе настройки окна.]=]
    ...
    "Активно показывает отображаемое имя, отображаемое в данный момент в окне."
    L["STRING_OPTIONS_MENU_ATTRIBUTE_ENCOUNTERTIMER"] = "Таймер сражения"
    L["STRING_OPTIONS_MENU_ATTRIBUTE_ENCOUNTERTIMER_DESC"] =
    "Когда включено секундомер отображается в левой части текста."
    ...
    "Скрыть кнопки автоматически, когда мышь покидает окно и показывать, когда вы снова взаимодействуйте с окном."
    L["STRING_OPTIONS_MENU_AUTOHIDE_LEFT"] = "Автоскрытие кнопок"
    L["STRING_OPTIONS_MENU_BUTTONSSIZE_DESC"] =
    "Выберите размер кнопок. Это также изменяет кнопки, добавленные в плагинах."
    ...
    "При блокировке они не будут взаимодействовать с помощью мыши и щелчков."
    L["STRING_OPTIONS_MICRODISPLAYS_DROPDOWN_TOOLTIP"] =
    "Выберите микро-дисплей, который вы хотите показать на этой стороне."
...
а сбоку панель состояния отключена.]=]
    ...
    "Выберите, что делать при щелчке по значку, на мини-карте левой кнопкой мыши."
...
Псевдонимы отправляются участникам гильдии с Details!, используется вместо имени персонажа.]=]
    ...
    "Сегменты с зачисткой мобов мусора, подземелья добавляются к общим данным."
    L["STRING_OPTIONS_OVERALL_LOGOFF"] = "Очищать при выходе из мира"
    L["STRING_OPTIONS_OVERALL_LOGOFF_DESC"] =
    "Когда включено, общие данные автоматически стираются при выходе из игрового мира."
    L["STRING_OPTIONS_OVERALL_MYTHICPLUS"] = "Очистить при старте Эпохального+"
    L["STRING_OPTIONS_OVERALL_MYTHICPLUS_DESC"] =
    "Когда включено, общие данные автоматически стираются при запуске нового эпохального+ прохождения."
    L["STRING_OPTIONS_OVERALL_NEWBOSS"] = "Очищать при новым рейдовым боссе"
    L["STRING_OPTIONS_OVERALL_NEWBOSS_DESC"] =
    "Когда включено, общие данные автоматически стираются при столкновении с другим рейдовым боссом."
    ...
    "Если это включено и вас выбрасывает из игры (отключением в подземелье), и вы сражались с боссом, все сегменты стираются, это делает ваш процесс выхода из мира быстрее."
    L["STRING_OPTIONS_PDW_ANCHOR"] = "Панели:"
    L["STRING_OPTIONS_PDW_SKIN_DESC"] =
    [=[Скин, который будет использоваться в окне детальной информации игрока, окне отчета и панели параметров.
...
|cFFFFFF00Relative Top Player|r: процент относительно предела очков лучшего игрока.]=]
    ...
    "Если эта настройка включена, эти параметры применяются, когда рейд совпадает с выбранным типом рейда."
    ...
    "Это тип рейдов, где различные параметры могут автоматически изменяться."
    ...
    "Если стоит галочка, кнопки плагина отображаются в правой части кнопок меню."
    ...
    "Эта предустановка слишком старая и не может быть загружена с этой версией Details!."
    ...
    "Сохранить расположение и размер окна в профиле. Когда отключено, каждый персонаж имеет свои значения."
    ...
    "Выберите существующий профиль или продолжайте использовать новый для этого персонажа:"
    ...
    "Скопировать все настройки из выбранного профиля в текущий профиль, перезаписывая все значения."
    ...
    "Загрузить существующий профиль. Если вы используете один и тот же профиль на всех персонажей (при параметре \"Использовать на всех персонажах\"), то создается исключение для этого персонажа."
    L["STRING_OPTIONS_PROFILES_TITLE"] = "Профили"
    L["STRING_OPTIONS_PROFILES_TITLE_DESC"] =
    "Эти параметры позволяют использовать одни и те же настойки для разных персонажей."
...
|cFFFFFF00Нижняя|r и |cFFFFFF00Верхняя|r: определяет, как будут написаны 'K' и 'M' в нижнем или верхнем регистре.]=]
    ...
    "Когда включено, только убийства против вражеских игроков рассчитываются на |cFFFFFF00урон > убийства|r в дисплее."
...
|cFFFFFF00Включено|r: Возлайт]=]
    ...
    [=[Когда отправляется отчет и при этом параметр включен, |cFF55FF55полезные|r заклинания сообщаются с помощью заклинания, а не его названия.
...
|cFFFF5555Вредные|r заклинания сообщаются по ссылкам по умолчанию.]=]
    ...
    [=[Какой канал чата используется для отправки предупреждающего сообщения.
...
Напишите в строку |cFFFFFF00{target}|r для того, чтобы добавить имя цели.]=]
    ...
    "Когда вы используйте кулдаун, сообщение отправляться по выбранному каналу."
    ...
    "Когда участник рейда умирает, отправляется сообщение в рейдовый канал, отчего умер тот игрок."
...
Если выбран |cFFFFFF00Наблюдатель|r, то смерти показываются только для вас в чате.]=]
    ...
    "Печатает в панель чата (|cFFFFFF00только для вас|r), кто нанёс первый удар, как правило, это тот кто начал бой."
    ...
    "Когда включено после рейдового сражения пишет в чате (|cFFFFFF00только для вас|r), кто использовал зелье в /pull."
...
Напишите в строку |cFFFFFF00{next}|r для того, чтобы добавить имя следующего игрока для прерывания его нужно вписать в 'следующий игрок'.]=]
    ...
    "При наличии последовательности прерываний поместите имя игрока, ответственного за следующее прерывание."
    ...
    "На этой панели можно активировать несколько механизмов, помогающих вам во время рейдов."
    ...
    "Сохранить текущий скин в качестве предустановки, вы можете экспортировать или сохранить ее в качестве резервной копии."
    ...
    "Скин успешно импортирован в списке сохраненных скинов. Теперь вы можете применить его с помощью поля 'Применить'."
    L["STRING_OPTIONS_SAVELOAD_LOAD"] = "Применить"
    L["STRING_OPTIONS_SAVELOAD_LOAD_DESC"] =
    "Выберите один из предыдущих сохраненных скинов, чтобы применить к текущему выбранному окну."
...
Этот скин применяется ко всем новым созданным окнам.]=]
    ...
    "Стандартный скин сохранен, новые окна будут использовать этот скин по умолчанию."
...
Высокие значения могут увеличить время, затрачиваемое на выход из системы.]=]
    ...
    "Выберите цвет. Значение прозрачности соответствует альфа-значению строки."
    ...
    "Перемещение и изменение размера окон |cFFFFFF00#1|r и |cFFFFFF00#2|r над правым чатом."
...
Цвет границы: |cFFFFFF00Прозрачный|r.]=]
    ...
    [=[Кнопка растягивания будет размещена на ПОЛНОЭКРАННОМ слое и всегда оставаться выше остальных рамок.
...
Игнорируется, если включен |cFFFFFFFFцвет по классу|r.]=]
    ...
    "Пусть эти русские буквы, которые никто не понимает, будут представлены как латинские буквы."
    ...
    "Выберите символ, используемый для открытия и закрытия блока в секунду и процент."
    ...
    "Выберите символ, используемый для oтделения суммы в секунду от процентной суммы."
...
Для примера: всего нанесено урона, всего исцеления получено.]=]
    ...
    "Выберите текст, а затем нажмите на кнопку цвета, чтобы изменить выбранный цвет текста."
...
Пример: 1500000 на 1.5kk.]=]
    ...
    [=[|cFFFFFF00Активный|r: таймер каждого участника рейда ставится на удержание, если их активность прекращается, и снова подсчитывается при возобновлении, общий способ измерения УВС и ИВС.
...
|cFFFFFF00Важно|r: при изменении положения текст заголовка не изменится, проверьте раздел |cFFFFFF00Полоса заголовка: Текст|r для дополнительных параметров.]=]
    ...
    "Какая сторона подсказки используется, чтобы соответствовать со стороной крепления якоря."
    ...
    "Переместить положение крепления, когда крепление находится в |cFFFFFF00Точка на экране|r."
    L["STRING_OPTIONS_TOOLTIPS_ANCHOR_TO_DESC"] =
    "Подсказки прикрепляются к наведенной строке или к выбранной точке игрового экрана."
    ...
    "Когда включено, некоторые меню могут использовать свои собственные обои в подменю."
    L["STRING_OPTIONS_TOOLTIPS_MAXIMIZE"] = "Метод развертывания"
    L["STRING_OPTIONS_TOOLTIPS_MAXIMIZE_DESC"] =
    [=[Выберите метод, используемый для развертывания информации, показанной на подсказке.
...
|cFFFFFF00 Только блок Alt|r: третий блок всегда расширяется по умолчанию.]=]
    ...
    "Показывает число, указывающее количество заклинаний, целей и питомцев в подсказке."
    ...
    "В течение |cFFFFFF00X|r секунд, отключается автоматическое переключение, чтобы показать сегменты мусора (|cFFFFFF00только, после победы над боссом|r)."
...
C:/Program Files/World of Warcraft/Interface/]=]
    ...
    "Закрыть текущее окно редактирования. Когда окно закрыто, окно является неактивным и оно может быть возобновлено в любое время с помощью меню управления. |cFFFFFF00Важно:|r чтобы полностью удалить окно, перейдите в раздел 'Окно:Общее'."
...
При блокировке окно не может быть перемещено.]=]
    ...
    "При включении этого окна не влияет на скрытие, отображении или переключении всех окон."
...
|cFFFFFF00Текущий|r: %s]=]
    ...
    "Изменяет цвет скина, применяемого к этому окнe. |cFFFFFF00Важно|r: выбранный здесь альфа-канал перезаписывается значениями |cFFFFFF00Автоматическая прозрачность|r при включении. |cFFFFFF00Важно|r: выбор цвета скина перезаписывает любые настройки цвета, примененные к строке состояния.."
...
-|cFFFFFF00Четыре угла|r: выравнивание с указанным углом, автоматическое изменение размера не производится.]=]
    ...
    "Открыть редактор изображений, чтобы изменить некоторые аспекты выбранного изображения."
    ...
    "Эти параметры управляют автоматическим поведением окна, таким как автоматическое скрытие и автоматическое переключение."
    ...
    "Details! не удается установить подключаемый модуль, поскольку имя уже было принято"
    ...
    "Когда внутри рейда, показывать значок Details! заголовке показывающий настой, еду, использование препота."
    ...
    "Отображение только тех данных, которые отображаются в данный момент (если поддерживается)."
    ...
    "Ваши очки |cFFFFFF00%s|r, Ваш лучший результат был |cFFFFFF00%s|r на %s с %d уровнем предметов."
    ...
    "установить все конфигурации по умолчанию, используйте это, если Details! не работает должным образом."
...
Чтобы полностью удалить окно, перейдите к параметрам -> Окно: Общее -> Удалить.]=]
    ...
    "Общие данные обновляются только после завершения боя, если вы хотите получать регулярные обновления, щелкните ПКМ на строку заголовка и выберите пункт \"динамические общие данные\"."
    ...
    L["STRING_WAITPLUGIN"] =
    "Плагин недоступен, проверьте: - Esc > Аддоны > включен ли там. - Страница плагинов в Details! опции. - Плагин открылся в другом окне. - Плагин используется в закрытом окне."
    L["STRING_WAVE"] = "волна"
...
Используйте стрелки в правом нижнем углу для навигации.]=]
    ...
    L["STRING_WELCOME_12"] =
    "Выберите скорость обновления окна, Вы также можете включить анимацию обновления в режиме реального времени для чисел ИВС и УВС."
...
|cffffff00Важно|r: Для Ютуберов и Стримеров, возможно, захотите включить, чтобы увеличить зрелищность для зрителей.]=]
    ...
    L["STRING_WELCOME_27"] =
    [=[Подсвеченная кнопка - это растягивание. |cFFFFFF00Удерживайте|r и |cFFFFFF00тяните вверх!|r.
...
|cFFFFFF00Важно|r: все настройки можно изменить позже на панели параметров.]=]
    ...
    L["STRING_WELCOME_6"] =
    "таймер каждого участника рейда будет приостановлен, если их активность будет прекращена, и снова рассчитываться при ее возобновлении."
    ...
    L["STRING_WELCOME_62"] =
    "Отправляется другим участникам Вашей гильдии, которые тоже используют Details!. Изменяя имя Вашего персонажа на псевдоним."
    L["STRING_WELCOME_63"] = "Обновление УВС/ИВС в реальном времени"
    L["STRING_WELCOME_64"] =
    [=[Когда включено, УВС и ИВС обновляется очень быстро, не дожидаясь следующего обновления окна.
...
Они также живут счастливее, как пара.]=]
    L["STRING_WELCOME_67"] =
    [=[Нажмите shift, чтобы развернуть всплывающую подсказку игрока, чтобы показать все используемые заклинания.
...
Примеры: измеритель угроз, анализ увс, сводка сражения, создание диаграмм и многое другое.]=]
    ...
    L["STRING_WELCOME_7"] =
    "используется для рейтинга, этот метод считывает прошедшее время боя для измерения DPS и HPS всех участников рейда."
