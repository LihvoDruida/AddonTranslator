function LoadScrapUkrainizer()
  if IsAddOnLoaded("Scrap") then
    ...
    -- dialogs
    L.ConfirmDelete = 'Ви впевнені, що хочете знищити всі сміття? Цю дію не можна буде скасувати.'
    ...
    L.SellPricesTip =
    'Якщо увімкнено, ціни продажу предметів будуть показуватися в спливаючих підказках, навіть коли ви не у торговця.'
    ...
    L.LowConsumeTip = 'Якщо увімкнено, Scrap буде продавати |cffff2020ВСІ|r низькорівневі для вас споживчі товари.'
