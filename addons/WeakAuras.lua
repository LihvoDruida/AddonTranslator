function LoadWeakAurasUkrainizer()
        if IsAddOnLoaded("WeakAuras") then
                local L = _G.WeakAuras.L
...
Can use \ to escape -.]=] ] = [=[ Формати фільтра: 'Ім'я', 'Ім'я-Світ', '-Світ'.

Підтримує кілька записів, розділених комами
Можна використовувати \ для екранування -.]=]
                L["%s Overlay Color"] = "%s Колір накладення"
                L["* Suffix"] = "* Суфікс"
                L["/wa help - Show this message"] = "/wa help - Показати це повідомлення"
                L["/wa minimap - Toggle the minimap icon"] = "/wa minimap - Ввімкнути/вимкнути значок на міні-карті"
                L["/wa pprint - Show the results from the most recent profiling"] =
                "/wa pprint - Показати результати з останнього профілювання"
                ...
                "/wa pstart - Розпочати профілювання. Опціонально включити тривалість у секундах, після чого профілювання автоматично зупиниться. Щоб профілювати наступний бій/зустріч, передайте аргумент \"combat\" або \"encounter\"."
                L["/wa pstop - Finish profiling"] = "/wa pstop - Завершити профілювання"
                L["/wa repair - Repair tool"] = "/wa repair - Інструмент для ремонту"
                L["|cffeda55fLeft-Click|r to toggle showing the main window."] =
                "|cffeda55fЛівий-Клік|r переключати відображення основного вікна."
                L["|cffeda55fMiddle-Click|r to toggle the minimap icon on or off."] =
                "|cffeda55fСередній-Клік|r увімкнути або вимкнути значок на міні-карті."
                L["|cffeda55fRight-Click|r to toggle performance profiling window."] =
                "|cffeda55fПравий-Клік|r переключати вікно профілювання продуктивності."
                L["|cffeda55fShift-Click|r to pause addon execution."] =
                "|cffeda55fShift-Клік|r призупинити виконання доповнення."
...
|cffffff00*|r Yellow Unit settings will create clones for each matching unit while this trigger is providing Dynamic Info to the Aura.]=] ] =
                [=[• |cff00ff00Player|r, |cff00ff00Target|r, |cff00ff00Focus|r, and |cff00ff00Pet|r correspond directly to those individual unitIDs.
• |cff00ff00Specific Unit|r lets you provide a specific valid unitID to watch.
|cffff0000Note|r: The game will not fire events for all valid unitIDs, making some untrackable by this trigger.
• |cffffff00Party|r, |cffffff00Raid|r, |cffffff00Boss|r, |cffffff00Arena|r, and |cffffff00Nameplate|r can match multiple corresponding unitIDs.
• |cffffff00Smart Group|r adjusts to your current group type, matching just the "player" when solo, "party" units (including "player") in a party or "raid" units in a raid.
...
|cffffff00*|r Yellow Unit settings will create clones for each matching unit while this trigger is providing Dynamic Info to the Aura.]=]
                L["1. Profession 1. Accessory"] = "1. Професія 1. Аксесуар"
                L["1. Profession 2. Accessory"] = "1. Професія 2. Аксесуар"
                L["1. Professsion Tool"] = "1. Інструмент професії"
                L["10 Man Raid"] = "Рейд на 10 гравців"
                L["10 Player Raid"] = "Рейд на 10 гравців"
                L["10 Player Raid (Heroic)"] = "Рейд на 10 гравців (героїчний)"
                L["10 Player Raid (Normal)"] = "Рейд на 10 гравців (звичайний)"
                L["2. Profession 1. Accessory"] = "2. Професія 1. Аксесуар"
                L["2. Profession 2. Accessory"] = "2. Професія 2. Аксесуар"
                L["2. Professsion Tool"] = "2. Інструмент професії"
                L["20 Man Raid"] = "Рейд на 20 гравців"
                L["20 Player Raid"] = "Рейд на 20 гравців"
                L["25 Man Raid"] = "Рейд на 25 гравців"
                L["25 Player Raid"] = "Рейд на 25 гравців"
                L["25 Player Raid (Heroic)"] = "Рейд на 25 гравців (героїчний)"
                L["25 Player Raid (Normal)"] = "Рейд на 25 гравців (звичайний)"
                L["40 Man Raid"] = "Рейд на 40 гравців"
                L["40 Player Raid"] = "Рейд на 40 гравців"
                L["5 Man Dungeon"] = "Підземелля"
                L["A trigger in this aura is set up to track a soft target unit, but you don't have the CVars set up for this to work correctly. Consider either changing the unit tracked, or configuring the Soft Target CVars."] =
                "Тригер в цій аурі налаштований для відстеження м'якої цільової одиниці, але у вас немає налаштованих CVars, щоб це працювало правильно. Розгляньте зміну відстежуваної одиниці або налаштування Soft Target CVars."
                L["Abbreviate"] = "Скорочувати"
                L["AbbreviateLargeNumbers (Blizzard)"] = "Скорочення великих чисел (Blizzard)"
                L["AbbreviateNumbers (Blizzard)"] = "Скорочення чисел (Blizzard)"
                L["Absorb"] = "Поглинання"
                L["Absorb Display"] = "Відображення поглинання"
                L["Absorb Heal Display"] = "Відображення поглинання лікування"
                L["Absorbed"] = "Поглинено"
                L["Action Button Glow"] = "Сяйво кнопки дії"
                L["Action Usable"] = "Дія використовується"
                L["Actions"] = "Дії"
                L["Active"] = "Активно"
                L["Add"] = "Додати"
                L["Add Missing Auras"] = "Додати відсутні аури"
                L["Additional Trigger Replacements"] = "Додаткові заміни тригерів"
                L["Advanced Caster's Target Check"] = "Розширена перевірка цілі мага"
                L["Affected"] = "Пошкоджений"
                L["Affected Unit Count"] = "Кількість пошкоджених одиниць"
                L["Afk"] = "АФК"
                L["Aggro"] = "Агро"
                L["Agility"] = "Ловкість"
                L["Ahn'Qiraj"] = "Ан'Кіраж"
                L["Alchemy Cast Bar"] = "Панель заклинань алхімії"
                L["Alert Type"] = "Тип повідомлення"
                L["Algalon the Observer"] = "Альгалон Спостерігач"
                L["Alive"] = "Живий"
                L["All"] = "Всі"
                L["All States table contains a non table at key: '%s'."] =
                "Таблиця всіх станів містить не таблицю за ключем: '%s'."
                L["All Triggers"] = "Всі тригери"
                L["Alliance"] = "Альянс"
                L["Allow partial matches"] = "Дозволити часткові відповідності"
                L["Alpha"] = "Альфа"
                L["Alternate Power"] = "Альтернативна сила"
                L["Always"] = "Завжди"
                L["Always active trigger"] = "Тригер завжди активний"
                L["Always include realm"] = "Завжди включати область"
                L["Always True"] = "Завжди правда"
                L["Amount"] = "Кількість"
                L["Anchoring"] = "Прив'язка"
                L["And Talent"] = "І талант"
                L["Animations"] = "Анімації"
                L["Anticlockwise"] = "Проти годинникової стрілки"
                L["Anub'arak"] = "Ануб'арак"
                L["Anub'Rekhan"] = "Ануб'Рекан"
                L["Any"] = "Будь-який"
                L["Any Triggers"] = "Будь-які тригери"
                L["AOE"] = "AOE"
                L["Arcane Resistance"] = "Магічний опір"
                L["Archavon the Stone Watcher"] = "Архавон Страж Каменю"
                L[ [=[Are you sure you want to run the |cffff0000EXPERIMENTAL|r repair tool?
This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s]=] ] = [=[Ти впевнений, що хочеш запустити |cffff0000ЕКСПЕРИМЕНТАЛЬНИЙ|r інструмент відновлення?
Це перезапише будь-які зміни, які ти зробив після останнього оновлення бази даних.
Останнє оновлення: %s]=]
                L["Arena"] = "Arena"
                L["Armor (%)"] = "Armor (%)"
                ...
                "Can be used for e.g. checking if \"boss1target\" is the same as \"player\"."
                L["Cancel"] = "Cancel"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] =
                [=[Cannot change secure frame in combat lockdown. Find more information:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
                L["Can't schedule timer with %i, due to a World of Warcraft bug with high computer uptime. (Uptime: %i). Please restart your computer."] =
                "Can't schedule timer with %i, due to a World of Warcraft bug with high computer uptime. (Uptime: %i). Please restart your computer."
                L["Cast"] = "Cast"
                L["Cast Bar"] = "Cast Bar"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] =
                [=[COMBAT_LOG_EVENT_UNFILTERED without a filter is generally advised against as it’s very performance costly.
Find more information:
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=]
                ...
                L["Cooldown"] = "Cooldown"
                L["Cooldown bars show time before an ability is ready to be use, BigWigs prefix them with '~'"] =
                "Cooldown bars show time before an ability is ready to be use, BigWigs prefix them with '~'"
                ...
                "Cooldown Reduction changes the duration of seconds instead of showing the real time seconds."
                L["Cooldown/Charges/Count"] = "Cooldown/Charges/Count"
                L["Could not load WeakAuras Archive, the addon is %s"] =
                "Could not load WeakAuras Archive, the addon is %s"
                L["Count"] = "Count"
                ...
                "Enables (incorrect) round down of seconds, which was the previous default behavior."
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] =
                [=[Error '%s' created a secure clone. We advise deleting the aura. For more information:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
                L["Error decoding."] = "Error decoding."
                L["Error decompressing"] = "Error decompressing"
                L["Error decompressing. This doesn't look like a WeakAuras import."] =
                "Error decompressing. This doesn't look like a WeakAuras import."
                L["Error deserializing"] = "Error deserializing"
                L["Error Frame"] = "Error Frame"
                L["ERROR in '%s' unknown or incompatible sub element type '%s'"] =
                ...
                L["Fetches the name and icon of the Legendary Power that matches this bonus id."] =
                "Fetches the name and icon of the Legendary Power that matches this bonus id."
...
E.g. 1;2;1;2;2.5;3]=]
                ...
                L["Note, that cross realm transmission is possible if you are on the same group"] =
                "Note, that cross realm transmission is possible if you are on the same group"
                L["Note: Due to how complicated the swing timer behavior is and the lack of APIs from Blizzard, results are inaccurate in edge cases."] =
                "Note: Due to how complicated the swing timer behavior is and the lack of APIs from Blizzard, results are inaccurate in edge cases."
                L["Note: 'Hide Alone' is not available in the new aura tracking system. A load option can be used instead."] =
                "Note: 'Hide Alone' is not available in the new aura tracking system. A load option can be used instead."
                L["Note: The available text replacements for multi triggers match the normal triggers now."] =
                "Note: The available text replacements for multi triggers match the normal triggers now."
                L["Note: This trigger relies on the WoW API, which returns incorrect information in some cases."] =
                "Note: This trigger relies on the WoW API, which returns incorrect information in some cases."
...
Only if DBM shows it on it's bar]=]
                ...
                "Options will open after the login process has completed."
                ...
                L["Profiling started. It will end automatically in %d seconds"] =
                "Profiling started. It will end automatically in %d seconds"
                L["Profiling still running, stop before trying to print."] =
                "Profiling still running, stop before trying to print."
                ...
                L["Requires syncing the specialization via LibSpecialization."] =
                "Requires syncing the specialization via LibSpecialization."
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
                ...
                L["Set IDs can be found on websites such as classic.wowhead.com/item-sets"] =
                "Set IDs can be found on websites such as classic.wowhead.com/item-sets"
                L["Set IDs can be found on websites such as wowhead.com/item-sets"] =
                "Set IDs can be found on websites such as wowhead.com/item-sets"
                L["Set IDs can be found on websites such as wowhead.com/wotlk/item-sets"] =
                "Set IDs can be found on websites such as wowhead.com/wotlk/item-sets"
                ...
                L["Supports multiple entries, separated by commas. Escape ',' with \\"] =
                "Supports multiple entries, separated by commas. Escape ',' with \\"
                L["Supports multiple entries, separated by commas. Group Zone IDs must be prefixed with 'g', e.g. g277."] =
                "Supports multiple entries, separated by commas. Group Zone IDs must be prefixed with 'g', e.g. g277."
                L["Swing"] = "Swing"
                ...
                L["Thaddius"] = "Thaddius"
                L["The aura has overwritten the global '%s', this might affect other auras."] =
                "The aura has overwritten the global '%s', this might affect other auras."
                L["The effective level differs from the level in e.g. Time Walking dungeons."] =
                "The effective level differs from the level in e.g. Time Walking dungeons."
                L["The Eye of Eternity"] = "The Eye of Eternity"
                L["The Four Horsemen"] = "The Four Horsemen"
                L["The 'Key' value can be found in the BigWigs options of a specific spell"] =
                "The 'Key' value can be found in the BigWigs options of a specific spell"
                ...
                "The trigger number is optional, and uses the trigger providing dynamic information if not specified."
                L["There are %i updates to your auras ready to be installed!"] =
                "There are %i updates to your auras ready to be installed!"
                ...
                "This aura calls GetData a lot, which is a slow function."
                ...
                L["True"] = "True"
                L["Trying to repair broken conditions in %s likely caused by a WeakAuras bug."] =
                "Trying to repair broken conditions in %s likely caused by a WeakAuras bug."
                ...
                "Використайте /wa minimap, щоб знову показати значок на міні-карті."
                ...
                "Using WeakAuras.clones is deprecated. Use WeakAuras.GetRegion(id, cloneId) instead."
                L["Using WeakAuras.regions is deprecated. Use WeakAuras.GetRegion(id) instead."] =
                "Using WeakAuras.regions is deprecated. Use WeakAuras.GetRegion(id) instead."
                ...
                "Values/Remaining Time above this value are displayed as full progress."
                L["Values/Remaining Time below this value are displayed as no progress."] =
                "Values/Remaining Time below this value are displayed as no progress."
                ...
                L["Warning: Anchoring to your own child '%s' in aura '%s' is imposssible."] =
                "Warning: Anchoring to your own child '%s' in aura '%s' is imposssible."
                L["Warning: Full Scan auras checking for both name and spell id can't be converted."] =
                "Warning: Full Scan auras checking for both name and spell id can't be converted."
                ...
                "Warning: Name info is now available via %affected, %unaffected. Number of affected group members via %unitCount. Some options behave differently now. This is not automatically adjusted."
                L["Warning: Tooltip values are now available via %tooltip1, %tooltip2, %tooltip3 instead of %s. This is not automatically adjusted."] =
                "Warning: Tooltip values are now available via %tooltip1, %tooltip2, %tooltip3 instead of %s. This is not automatically adjusted."
...
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s]=]
                L["WeakAuras has encountered an error during the login process. Please report this issue at https://github.com/WeakAuras/Weakauras2/issues/new."] =
                "WeakAuras has encountered an error during the login process. Please report this issue at https://github.com/WeakAuras/Weakauras2/issues/new."
                ...
                "Your next encounter will automatically be profiled."
                L["Your next instance of combat will automatically be profiled."] =
                "Your next instance of combat will automatically be profiled."
                L["Your scheduled automatic profile has been cancelled."] =
                "Your scheduled automatic profile has been cancelled."
                L["Your threat as a percentage of the tank's current threat."] =
                "Your threat as a percentage of the tank's current threat."
                L["Your threat on the mob as a percentage of the amount required to pull aggro. Will pull aggro at 100."] =
                "Your threat on the mob as a percentage of the amount required to pull aggro. Will pull aggro at 100."
                ...
                -- WeakAuras/Options
                L[" and |cFFFF0000mirrored|r"] = "; і |cFFFF0000відображено|r"
                L["-- Do not remove this comment, it is part of this aura: "] =
                "-- Не видаляйте цей коментар, він частина цієї аури: "
                L[" rotated |cFFFF0000%s|r degrees"] = "; повернуто на %.4g градусів"
                L["% of Progress"] = "% від прогресу"
                L["%d |4aura:auras; added"] = "%d |4аура:аури; додано"
                L["%d |4aura:auras; deleted"] = "%d |4аура:аури; видалено"
                L["%d |4aura:auras; modified"] = "%d |4аура:аури; змінено"
                L["%i auras selected"] = "Вибрано %i |4аура:аури:аур"
                --[[Translation missing --]]
                L["%i."] = "%i."
                --[[Translation missing --]]
                L["%i. %s"] = "%i. %s"
                L["%s - %i. Trigger"] = "%s - %i. Тригер"
                L["%s - Alpha Animation"] = "%s - Анімація прозорості"
                L["%s - Color Animation"] = "%s - Анімація кольору"
                L["%s - Condition Custom Chat %s"] = "%s - Умова. Власне повідомлення у чаті %s"
                L["%s - Condition Custom Check %s"] = "%s - Умова. Власна перевірка %s"
                L["%s - Condition Custom Code %s"] = "%s - Умова. Власний код %s"
                L["%s - Custom Anchor"] = "%s - Власне прикріплення"
                L["%s - Custom Grow"] = "%s - Власний ріст"
                L["%s - Custom Sort"] = "%s - Власне сортування"
                L["%s - Custom Text"] = "%s - Власний текст"
                L["%s - Finish"] = "%s - Завершення"
                L["%s - Finish Action"] = "%s - Дія після закінчення"
                L["%s - Finish Custom Text"] = "%s - Власне повідомлення у чаті після закінчення"
                L["%s - Init Action"] = "%s - Дія при ініціалізації"
                L["%s - Main"] = "%s - Основне"
                L["%s - Option #%i has the key %s. Please choose a different option key."] =
                "Опція %s - #%i має ключ %s. Будь ласка, виберіть інший ключ опції."
                L["%s - Rotate Animation"] = "%s - Анімація обертання"
                L["%s - Scale Animation"] = "%s - Анімація масштабу"
                L["%s - Start"] = "%s - Початок"
                L["%s - Start Action"] = "%s - Дія при початку"
                L["%s - Start Custom Text"] = "%s - Власне повідомлення у чаті при початку"
                L["%s - Translate Animation"] = "%s - Анімація переміщення"
                L["%s - Trigger Logic"] = "%s - Логіка тригеру"
                L["%s %s, Lines: %d, Frequency: %0.2f, Length: %d, Thickness: %d"] =
                "%s %s, Лінії: %d, Частота: %0.2f, Довжина: %d, Товщина: %d"
                L["%s %s, Particles: %d, Frequency: %0.2f, Scale: %0.2f"] =
                "%s %s, Частинки: %d, Частота: %0.2f, Масштаб: %0.2f"
                L["%s %u. Overlay Function"] = "%s, Функція наложення %u"
                L["%s Alpha: %d%%"] = "%s Прозорість: %d%%"
                L["%s Color"] = "%s Колір"
                L["%s Custom Variables"] = "%s Власні змінні"
                L["%s Default Alpha, Zoom, Icon Inset, Aspect Ratio"] =
                "%s Значення за замовчуванням: прозорість, збільшення, внутрішній відступ і співвідношення сторін"
                L["%s Duration Function"] = "%s Функція тривалості"
                L["%s Icon Function"] = "%s Функція іконки"
                L["%s Inset: %d%%"] = "%s Внутрішній відступ: %d%%"
                L["%s is not a valid SubEvent for COMBAT_LOG_EVENT_UNFILTERED"] =
                "%s - недійсний SubEvent для COMBAT_LOG_EVENT_UNFILTERED"
                L["%s Keep Aspect Ratio"] = "%s Зберігати пропорції"
                L["%s Name Function"] = "%s Функція назви"
                L["%s Stacks Function"] = "%s Функція стеків"
                L["%s stores around %s KB of data"] = "%s зберігає приблизно %s КБ даних"
                L["%s Texture"] = "%s Текстура"
                L["%s Texture Function"] = "%s Функція текстури"
                L["%s total auras"] = "Всього %s аур"
                L["%s Trigger Function"] = "%s Функція тригеру"
                L["%s Untrigger Function"] = "%s Функція скасування тригеру"
                L["%s X offset by %d"] = "%s Зсув X на %d"
                L["%s Y offset by %d"] = "%s Зсув Y на %d"
                L["%s Zoom: %d%%"] = "%s Збільшення: %d%%"
                L["%s, Border"] = "%s, Обрамлення"
                L["%s, Offset: %0.2f;%0.2f"] = "%s, Зсув: %0.2f;%0.2f"
                L["%s, offset: %0.2f;%0.2f"] = "%s, Зсув: %0.2f;%0.2f"
                L["%s, Start Animation"] = "%s, Почати Анімацію"
                L["%s|cFFFF0000custom|r texture with |cFFFF0000%s|r blend mode%s%s"] =
                "%s власна текстура з режимом змішування |cFFE6CC80%s|r%s%s"
                L["(Right click to rename)"] = "(Натисніть правою кнопкою миші, щоб перейменувати)"
                L["|c%02x%02x%02x%02xCustom Color|r"] = "|c%02x%02x%02x%02xВласний колір|r"
                L["|cff999999Triggers tracking multiple units will default to being active even while no affected units are found without a Unit Count or Match Count setting applied.|r"] =
                "|cFF999999Тригери, які відстежують кілька одиниць, за замовчуванням будуть активними, навіть якщо жодна з постраждалих одиниць не знайдена без застосування параметрів Кількість одиниць або Кількість збігів.|r"
                L["|cFFE0E000Note:|r This sets the description only on '%s'"] =
                "|cFFFFCC00Примітка:|r Це встановлює опис лише для '%s'"
                L["|cFFE0E000Note:|r This sets the URL on all selected auras"] =
                "|cFFFFCC00Примітка:|r Це встановлює URL для всіх обраних аур"
                L["|cFFE0E000Note:|r This sets the URL on this group and all its members."] =
                "|cFFFFCC00Примітка:|r Це встановлює URL для цієї групи та всіх її елементів."
                L["|cFFFF0000Automatic|r length"] = "Автоматична довжина"

                -- Make missing translations available
                setmetatable(_G.WeakAuras.L, {
                ...
                -- Модуль WeakAuras не завантажений, виконайте відповідні дії або повідомлення
                print("[AddonTranslator]: Модуль WeakAuras не завантажений")
        end
end
